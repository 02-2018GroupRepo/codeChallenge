...
let arrOfPointsPerMinute=[]
for(i=0; i<players.length; i++){
  avgOfAvgMinutes += players[i].avgMinutesPlayed;
  pointsPerMinute = players[i].avgPoints / players[i].avgMinutesPlayed;
  arrOfPointsPerMinute.push(pointsPerMinute);
}
console.log(arrOfPointsPerMinute);
console.log("The average of team as a whole is: " + avgOfAvgMinutes/players.length);

let max = 0;
for(let i = 0 ; i < arrOfPointsPerMinute.length; i++){

  if(arrOfPointsPerMinute[i]>max){
    max = arrOfPointsPerMinute[i];
  }
